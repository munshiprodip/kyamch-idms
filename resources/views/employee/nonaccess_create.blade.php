      ...
      <div class="container-fluid">
        ...
        <div class="card ">
          ...
          <div class="card-header">
            ...
            <a href="{{ route('employee.index') }}" class="btn btn-outline-secondary float-right">VIEW LIST</a>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    {!! Form::select('blood_id', $bloods,[], array('class' => 'form-control select2','')) !!}
                  </div>                  
                </div>
                <input type="hidden" name="status" value="Not Printed">
