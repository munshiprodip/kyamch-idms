      ...
      <div class="container-fluid">
        ...
        <div class="card ">
          ...
          <div class="card-header">
            <h3 class="card-title">Edit Consumption </h3>
            <a href="{{ route('consumptions.index') }}" class="btn btn-outline-secondary float-right">VIEW LIST</a>
          </div>

          {!! Form::open(array('route' => ['consumptions.update', $consumption->id],'method'=>'PATCH')) !!}
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="name" required>
                      ...
                      <option {{($consumption->name == 0)? 'selected' : ''}} value="0">Proximity Card</option>
                      <option {{($consumption->name == 1)? 'selected' : ''}} value="1">Plastic Card</option>                    
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="employee_id" required>
                      ...
                      <option {{($consumption->employee_id == $employee->id)? 'selected' : ''}} value="{{$employee->id}}">{{ $employee->employee_id}} - {{ $employee->name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="quentity" type="number" value="{{$consumption->quentity}}">
                  </div>                 
                </div>
