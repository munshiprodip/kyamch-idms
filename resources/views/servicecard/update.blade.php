    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card ">
                ...
                {!! Form::model($servicecard, ['method' => 'PATCH','route' => ['servicecard.update', $servicecard->id], 'enctype'=>'multipart/form-data']) !!}
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('department_id', $departments,$servicecardDepartment, array('class' => 'form-control select2','')) !!}
                            </div>
